...
extension Waveform1D where T == Double {
    ...
    public static func + (lhs: Waveform1D<T>, rhs: Waveform1D<T>) -> Waveform1D<T> {
        ...
        return Waveform1D<T>(values: result, dt: lhs.dt, t0: lhs.t0)
    }

    public static func + (lhs: Waveform1D<T>, rhs: Double) -> Waveform1D<T> {
        let result = lhs.values.map { $0 + rhs }
        return Waveform1D<T>(values: result, dt: lhs.dt, t0: lhs.t0)
    }

    public static func + (lhs: Double, rhs: Waveform1D<T>) -> Waveform1D<T> {
        let result = rhs.values.map { $0 + lhs }
        return Waveform1D<T>(values: result, dt: rhs.dt, t0: rhs.t0)
    }
...
extension Waveform1D where T == Float {
    ...
    public static func + (lhs: Waveform1D<T>, rhs: Float) -> Waveform1D<T> {
        let result = lhs.values.map { $0 + rhs }
        return Waveform1D<T>(values: result, dt: lhs.dt, t0: lhs.t0)
    }

    public static func + (lhs: Float, rhs: Waveform1D<T>) -> Waveform1D<T> {
        let result = rhs.values.map { $0 + lhs }
        return Waveform1D<T>(values: result, dt: rhs.dt, t0: rhs.t0)
    }
