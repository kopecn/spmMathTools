...
extension Waveform1D where T == Double {
    ...
    public func elementsEqual(to other: Waveform1D<Double>) -> [Bool] {
    ...
    public func elementsLessThan(_ other: Waveform1D<Double>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] < other.values[$0] }
    }
    ...
    public func elementsGreaterThan(_ other: Waveform1D<Double>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] > other.values[$0] }
    }
    ...
    public func elementsApproximatelyEqual(to other: Waveform1D<Double>, tolerance: Double = 1e-10) -> [Bool] {
        let count = min(values.count, other.values.count)
...
extension Waveform1D where T == Float {
    ...
    /// Element-wise equality
    public func elementsEqual(to other: Waveform1D<Float>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] == other.values[$0] }
    }
    ...
    /// Element-wise less than
    public func elementsLessThan(_ other: Waveform1D<Float>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] < other.values[$0] }
    }
    ...
    /// Element-wise greater than
    public func elementsGreaterThan(_ other: Waveform1D<Float>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] > other.values[$0] }
    }
    ...
    /// Element-wise approximate equality
    public func elementsApproximatelyEqual(to other: Waveform1D<Float>, tolerance: Float = 1e-6) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { abs(values[$0] - other.values[$0]) <= tolerance }
    }
...
extension Waveform1D where T == Int {
    ...
    /// Element-wise equality
    public func elementsEqual(to other: Waveform1D<Int>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] == other.values[$0] }
    }
    ...
    /// Element-wise less than
    public func elementsLessThan(_ other: Waveform1D<Int>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] < other.values[$0] }
    }
    ...
    /// Element-wise greater than
    public func elementsGreaterThan(_ other: Waveform1D<Int>) -> [Bool] {
        let count = min(values.count, other.values.count)
        return (0..<count).map { values[$0] > other.values[$0] }
    }
